...
(function (root, factory) {
  ...
  protoOf(Enum).c = function () {
    return this.a_1;
  };
  protoOf(Enum).d = function () {
    return this.b_1;
  };
  protoOf(Enum).e = function (other) {
    return compareTo(this.b_1, other.b_1);
  };
  ...
  function implement(interfaces) {
    ...
    while (inductionVariable < last) {
      ...
      if (!(iidImask == null)) {
        masks.push(iidImask);
        currentSize = Math.max(currentSize, iidImask.f_1.length);
      }
  ...
  function implement$lambda($tmp) {
    return function (acc, it) {
      return $tmp >= it.f_1.length ? acc : acc | it.f_1[$tmp];
    };
  }
  ...
  function Companion() {
    ...
    this.k_1 = new Long(0, -2147483648);
    this.l_1 = new Long(-1, 2147483647);
    this.m_1 = 8;
    this.n_1 = 64;
  }
  ...
  protoOf(Long).r = function () {
    return this.s().p(new Long(1, 0));
  };
  protoOf(Long).s = function () {
    return new Long(~this.g_1, ~this.h_1);
  };
  protoOf(Long).t = function () {
    return this.g_1;
  };
  protoOf(Long).i = function () {
  ...
  function subtract(_this__u8e3s4, other) {
    _init_properties_longjs_kt__tqrzid();
    return add(_this__u8e3s4, other.r());
  }
  ...
  function divide(_this__u8e3s4, other) {
    ...
    if (equalsLong(_this__u8e3s4, get_MIN_VALUE())) {
      if (equalsLong(other, get_ONE()) ? true : equalsLong(other, get_NEG_ONE())) {
        ...
        var approx = shiftLeft(halfThis.q(other), 1);
        if (equalsLong(approx, get_ZERO())) {
          return isNegative(other) ? get_ONE() : get_NEG_ONE();
        } else {
          var rem = subtract(_this__u8e3s4, multiply(other, approx));
          return add(approx, rem.q(other));
        }
      }
    } else if (equalsLong(other, get_MIN_VALUE())) {
      return get_ZERO();
    ...
    if (isNegative(_this__u8e3s4)) {
      var tmp;
      if (isNegative(other)) {
        tmp = negate(_this__u8e3s4).q(negate(other));
      } else {
        tmp = negate(negate(_this__u8e3s4).q(other));
      }
      return tmp;
    } else if (isNegative(other)) {
      return negate(_this__u8e3s4.q(negate(other)));
    }
    var res = get_ZERO();
  ...
  function toStringImpl(_this__u8e3s4, radix) {
    ...
    if (isNegative(_this__u8e3s4)) {
      if (equalsLong(_this__u8e3s4, get_MIN_VALUE())) {
        ...
        var div = _this__u8e3s4.q(radixLong);
    ...
    var result = '';
    while (true) {
      var remDiv = rem_0.q(radixToPower);
  ...
  function generateInterfaceId(_this__u8e3s4) {
    ...
    tmp0_this.u_1 = tmp0_this.u_1 + 1 | 0;
  ...
  _.$_$.f = objectMeta;
  _.$_$.g = protoOf;
  _.$_$.h = setMetadataFor;
  _.$_$.i = KMutableProperty0;
  _.$_$.j = THROW_ISE;
  _.$_$.k = ensureNotNull;
  _.$_$.l = VOID;
  //endregion
