...
public class GuestWindow extends JFrame {
    ...
    private void initContainer(String title, int x, int y, int width, int height) {
        ...
        buttonPanel.setBounds(0, 500, 1000, 1000);
        add(buttonPanel);
        ...
        enterButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                message.setFont(ft);
                if (nameField.getText().isEmpty() || phoneField.getText().isEmpty()) JOptionPane.showMessageDialog(enterButton, message, "고객 정보", JOptionPane.ERROR_MESSAGE);
                else {
